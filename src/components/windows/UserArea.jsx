...
const Rules = React.lazy(() => import(/* webpackChunkName: "stats" */ '../Rules'));
// eslint-disable-next-line max-len
const Factions = React.lazy(() => import(/* webpackChunkName: "converter" */ '../Factions'));
// eslint-disable-next-line max-len
...
// eslint-disable-next-line max-len
const Void = React.lazy(() => import(/* webpackChunkName: "void" */ '../Void'));
...
const UserArea = () => {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <a href="./guilded" target="_blank">pixelplace.xyz/discord</a>
      <br />
    </div>
  );
};
