...
const Help = () => {
  ...
  const guildedLink = <a href="https://pixelplace/discord">guilded</a>;
  const mailLink = <a href="mailto:admin@pixelplace.xyz">admin@pixelplace.xyz</a>;
  ...
  return (
    <div className="content">
      ...
      <p className="modalinfo">Discord ({t`recommended`}): <a href="./discord" target="_blank" rel="noopener noreferrer">pixelplace.xyz/discord</a></p>
